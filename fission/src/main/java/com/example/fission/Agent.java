...
public class Agent {
    ...
    //0为普通网民 1为平台用户 2为种子选手
    public int status = 0;
    public int possibleReward; //如果成功可以得到的奖励
    ...
    //本次任务
    public boolean fissionable = false; //可以发送/参与游戏
...
//    }
    ...
    public void resetCurFissionCount(){
    ...
    public int getPossibleReward() {
        return possibleReward;
    }

    public void setPossibleReward(int possibleReward) {
